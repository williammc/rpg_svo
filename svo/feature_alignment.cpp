    ...
    double& h_inv)
{
  ...
  float ALIGNED_(16) ref_patch_dv[patch_area];
    ...
    bool no_simd)
{
  ...
  // compute derivative of template and prepare inverse compositional
  float ALIGNED_(16) ref_patch_dx[patch_area_];
  float ALIGNED_(16) ref_patch_dy[patch_area_];
    ...
    Vector2d& cur_px_estimate)
{
  ...
  // compute derivative of template and prepare inverse compositional
  int16_t ALIGNED_(16) ref_patch_dx[patch_area];
  int16_t ALIGNED_(16) ref_patch_dy[patch_area];
