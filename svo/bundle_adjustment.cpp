    ...
    Map* map)
{
  ...
  // frame1->T_f_w_ = v_frame1->estimate();
  // frame2->T_f_w_ = v_frame2->estimate();

  frame1->T_f_w_.so3() = v_frame1->estimate().rotation().toRotationMatrix();
  frame1->T_f_w_.translation() = v_frame1->estimate().translation();
  frame2->T_f_w_.so3() = v_frame2->estimate().rotation().toRotationMatrix();
